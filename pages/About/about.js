          ...
          <div className="padding-global">
            <div className="container-large">
              <div className="padding-section-medium">
                <div className="header-component is-about">
                  <div
                  ...
                  <div className="header-image-wrapper is-about">
                    ...
                    <img
                      ...
                      className="illustration is-about-bottom-left"
                    />
                    <img
              ...
              <div className="padding-section-large">
                <div className="w-layout-grid projects-component">
                  <div className="projects-item">
                    <h2 className="text-color-white">+ 150</h2>
                    <p>Annual Partner</p>
                  </div>
                  <div className="projects-item">
                    <h2 className="text-color-white">+ 57 k</h2>
                    <p>Completed Projects</p>
                  </div>
                  <div className="projects-item">
                    <h2 className="text-color-white">+ 500</h2>
                    <p>Happy Customers</p>
                  </div>
                  <div className="projects-item">
            ...
            <div className="container-large">
              <div className="padding-section-large">
                <div className="text-align-center">
                  <div
                    data-w-id="cca45aa4-d8e9-04fd-47fd-1d32644b2d9f"
                    style={{
                      WebkitTransform:
                        "translate3d(null, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                      mozTransform:
                ...
                <div
                  data-w-id="cca45aa4-d8e9-04fd-47fd-1d32644b2da9"
                  style={{
                    WebkitTransform:
                      "translate3d(null, 40px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                    mozTransform:
                  ...
                  <div className="team-list-wrapper w-dyn-list">
                    <div role="list" className="team-list w-dyn-items">
                      <div role="listitem" className="team-item w-dyn-item">
                        ...
                        <div className="text-size-large text-weight-semibold"></div>
                        <div className="team-job-tittle-wrapper">
                        ...
                        <div className="w-layout-grid team-social">
                          <a href="#" className="social-link w-inline-block">
                            <img
                              src="/assets/Social-icon-1_1Social-icon-1.webp"
                              loading="lazy"
                              alt="Social Icon"
                          ...
                          <a href="#" className="social-link w-inline-block">
                            <img
                              src="/assets/Social-icon_1Social-icon.webp"
                              loading="lazy"
                              alt="Social Icon"
                              className="social-icon"
                            />
                          ...
                          <a href="#" className="social-link w-inline-block">
                            <img
                              src="/assets/Social-icon-2_1Social-icon-2.webp"
                              loading="lazy"
                              alt="Social Icon"
                              className="social-icon"
                            />
          ...
          <div className="padding-global">
            <div className="container-large">
              <div className="padding-section-large">
                <div className="text-align-center">
                  <div
                    data-w-id="5af42538-5e12-b5dd-a2cf-86297969a073"
                    className="max-width-large align-center"
                  >
                ...
                <div className="w-layout-grid features-component">
                  <div
                    data-w-id="5af42538-5e12-b5dd-a2cf-86297969a07d"
                    ...
                    <div className="features-item-top">
                      <div className="features-item-icon-wrapper">
                        <img
                          ...
                          alt="The man&#x27,s hand a black-and-white image of a clock"
                          className="icon-1x1-medium"
                        />
                      </div>
                    ...
                    <div className="features-item-top">
                      <div className="features-item-icon-wrapper">
                        <img
                          ...
                          alt="Settings Icon connecting with three-person"
                          className="icon-1x1-medium"
                        />
                      </div>
          ...
          <div className="padding-global">
            <div className="container-small">
              <div className="padding-section-large">
                <div className="text-align-center">
                  <div
                    data-w-id="cd39649f-ae66-ef57-0d4b-b512a12ec961"
                    className="max-width-large align-center"
                  >
                ...
                <div className="padding-bottom padding-xxlarge"></div>
                <div
                  data-w-id="cd39649f-ae66-ef57-0d4b-b512a12ec969"
                ...
                <div className="padding-bottom padding-xxlarge"></div>
                <div
                  data-w-id="cd39649f-ae66-ef57-0d4b-b512a12ec971"
