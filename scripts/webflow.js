...
/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, exports) {
      /**
       * Checks if `value` is classNameified as an `Array` object.
       *
       * @static
       * @memberOf _
       * @since 0.1.0
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * Checks if `value` is classNameified as a typed array.
       *
       * @static
       * @memberOf _
       * @since 3.0.0
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ActionTypeConsts = {
        ...
        GENERAL_COMBO_className: "GENERAL_COMBO_className",
...
*/
      ...
      (function () {
        ...
        var checkParentContainer = function checkParentContainer($container) {
          ...
          } // Add a CSS className hook, in case people need to override styles for any reason.
      ...
      Webflow.define(
        ...
        (module.exports = function ($) {
          ...
          function createBadge() {
            var $brand = $('<a className="w-webflow-badge"></a>').attr(
              "href",
      ...
      Webflow.define(
        ...
        (module.exports = function () {
          ...
          function applyFocusVisiblePolyfill(scope) {
             ...
             * `focus-visible` className being added, i.e. whether it should always match
            ...
            /**
             * On `focus`, add the `focus-visible` className to the target if:
            ...
            /**
             * On `blur`, remove the `focus-visible` className from the target.
             * @param {Event} e
             */
            ...
            function onVisibilityChange() {
              if (document.visibilityState === "hidden") {
                ...
                // re-apply the className when the user switches back to the tab.
...
*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var uncurryThis = __webpack_require__(5);
      var fails = __webpack_require__(19);
      var classNameof = __webpack_require__(147);
      ...
      module.exports = fails(function () {
        ...
        ? function (it) {
            return classNameof(it) == "String" ? split(it, "") : Object(it);
          }
        : Object;
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function select(link) {
            ...
            setclassName($link, linkCurrent, match);
          }
          ...
          function scroll() {
            ...
            _.each(anchors, function (anchor) {
              ...
              setclassName($link, linkCurrent, active);
            });
          }

          function setclassName($elem, className, add) {
            var exists = $elem.hasclassName(className);
      ...
      Webflow.define(
        ...
        (module.exports = function ($) {
          ...
          function setFocusable($el, action) {
            ...
            $el.toggleclassName("wf-force-outline-none", action === "add");
          }
          /**
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function open(data) {
            ...
            closeOthers(data);
            data.open = true;
            data.list.addclassName(openStateclassName);
            data.toggle.addclassName(openStateclassName);
          ...
          function complete(data) {
            return function () {
              data.list.removeclassName(openStateclassName);
              data.toggle.removeclassName(openStateclassName); // Reset z-index for managed dropdowns
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          function addListeners() {
            ...
            var CHECKBOX_className_NAME = ".w-checkbox-input";
            var RADIO_INPUT_className_NAME = ".w-radio-input";
            var CHECKED_className = "w--redirected-checked";
            var FOCUSED_className = "w--redirected-focus";
            var FOCUSED_VISIBLE_className = "w--redirected-focus-visible";
            var focusVisibleSelectors =
              ":focus-visible, [data-wf-focus-visible]";
            var CUSTOM_CONTROLS = [
              ["checkbox", CHECKBOX_className_NAME],
              ["radio", RADIO_INPUT_className_NAME],
            ];
            $doc.on(
              "change",
              namespace +
                ' form input[type="checkbox"]:not(' +
                CHECKBOX_className_NAME +
                ")",
              function (evt) {
                $(evt.target)
                  .siblings(CHECKBOX_className_NAME)
                  .toggleclassName(CHECKED_className);
              }
            );
            $doc.on(
              "change",
              ...
              function (evt) {
                $(
                  'input[name="'
                    ...
                    .concat(CHECKBOX_className_NAME, ")")
                ).map(function (i, el) {
                  return $(el)
                    .siblings(RADIO_INPUT_className_NAME)
                    .removeclassName(CHECKED_className);
                });
                var $target = $(evt.target);

                if (!$target.hasclassName("w-radio-input")) {
                  $target
                    .siblings(RADIO_INPUT_className_NAME)
                    .addclassName(CHECKED_className);
                }
              }
            );
              ...
              $doc.on(
                ...
                function (evt) {
                  $(evt.target)
                    ...
                    .addclassName(FOCUSED_className);
                  $(evt.target)
                    .filter(focusVisibleSelectors)
                    .siblings(customControlclassName)
                    .addclassName(FOCUSED_VISIBLE_className);
                }
              );
              $doc.on(
                "blur",
                ...
                function (evt) {
                  $(evt.target)
                    ...
                    .removeclassName(
                      ""
                        .concat(FOCUSED_className, " ")
                        .concat(FOCUSED_VISIBLE_className)
                    );
                }
              );
            });
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      Webflow.define(
        ...
        (module.exports = function ($, _) {
          ...
          var inEditor;
          var inApp = Webflow.env();
          var overlay = '<div className="w-nav-overlay" data-wf-ignore />';
          var namespace = ".w-nav";
          ...
          function open(data, immediate) {
            ...
            data.links.addclassName(navbarOpenedLink);
            data.dropdowns.addclassName(navbarOpenedDropdown);
            data.dropdownToggle.addclassName(navbarOpenedDropdownToggle);
            data.dropdownList.addclassName(navbarOpenedDropdownList);
            data.button.addclassName(navbarOpenedButton);
            var config = data.config;
            var animation = config.animation;
          ...
          function close(data, immediate) {
            ...
            data.open = false;
            data.button.removeclassName(navbarOpenedButton);
            var config = data.config;
            ...
            function complete() {
              ...
              data.links.removeclassName(navbarOpenedLink);
              data.dropdowns.removeclassName(navbarOpenedDropdown);
              data.dropdownToggle.removeclassName(navbarOpenedDropdownToggle);
              data.dropdownList.removeclassName(navbarOpenedDropdownList);
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "6419710b82d66c7714b1e3bb|589d6368-dd9b-b54f-ac4e-e7860d753f0f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419710b82d66c7714b1e3bb|589d6368-dd9b-b54f-ac4e-e7860d753f1b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-9": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "f8d69e92-d5d3-099c-4e54-a575096e36eb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-28": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "20ec7267-8628-5b61-6b1d-2a4f5c42810e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-34": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".integrations-card",
        originalId:
          "6419710b82d66c7714b1e3bb|5599192b-db46-1764-43c3-8e0220708281",
        appliesTo: "className",
      },
      targets: [
        {
    ...
    "e-36": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e28",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-38": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e4c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-40": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e70",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-42": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e3a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-44": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e5e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-46": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e82",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-48": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e20",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-50": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|7846325c-432c-98e7-7734-a73e5bd21d0f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-52": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|7846325c-432c-98e7-7734-a73e5bd21d17",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-54": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "7b3cbc37-757d-6367-729e-39573c188ba2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-56": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "c6aa9a1b-16cb-0b97-4c9e-72c333ca05e1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-58": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "ee06d3d3-db8d-42e1-87c9-74ade7d0460d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-60": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|eeb22a88-7d3e-0834-0527-2b1b3e9fb87b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-62": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|eeb22a88-7d3e-0834-0527-2b1b3e9fb893",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-64": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|a23e38df-c5fd-7f6e-3337-83d2117a2244",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-66": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|b80b15a7-5a26-f500-032d-f0d8615bd113",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-68": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "e1d3f33e-234f-fbb8-6bed-2ff90c184276",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-70": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "e1d3f33e-234f-fbb8-6bed-2ff90c184277",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-72": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "e1d3f33e-234f-fbb8-6bed-2ff90c184278",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-74": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "e1d3f33e-234f-fbb8-6bed-2ff90c184279",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-76": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "e1d3f33e-234f-fbb8-6bed-2ff90c18427a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-78": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|485b134f-0239-a7c0-586f-7c65061310b7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-80": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|485b134f-0239-a7c0-586f-7c65061310c0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-82": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|485b134f-0239-a7c0-586f-7c6506131137",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-84": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|39029031-31e7-8614-e7f4-6b9331da9c60",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-86": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|39029031-31e7-8614-e7f4-6b9331da9c86",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-88": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|5c3c40ad-b62b-1733-6a90-387347c51fff",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-90": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|5c3c40ad-b62b-1733-6a90-387347c51fe3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-92": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1f261cf3-006b-41c8-e3e4-91b9eadcb929",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-94": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1f261cf3-006b-41c8-e3e4-91b9eadcb94f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-96": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|5599192b-db46-1764-43c3-8e0220708277",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-98": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|5599192b-db46-1764-43c3-8e0220708293",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-100": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|5599192b-db46-1764-43c3-8e0220708298",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-102": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|2fde9152-e243-ce3d-53f7-fda79d1c4e21",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-104": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3af3ce62-e206-cc52-3a38-fdc4e64b600e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-106": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3af3ce62-e206-cc52-3a38-fdc4e64b6024",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-108": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3af3ce62-e206-cc52-3a38-fdc4e64b6034",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-110": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3af3ce62-e206-cc52-3a38-fdc4e64b6042",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-114": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7714b1e3bb|485b134f-0239-a7c0-586f-7c6506131136",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-116": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c2a15b1e3cf|c5245d6e-ecdb-c162-27fe-fe3cd010b355",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-117": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c2a15b1e3cf|c5245d6e-ecdb-c162-27fe-fe3cd010b357",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-119": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c2a15b1e3cf|c5245d6e-ecdb-c162-27fe-fe3cd010b365",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-121": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a073",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-123": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a07d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-125": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a08a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-127": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a097",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-129": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0a4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-131": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0b1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-133": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0be",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-135": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0cb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-137": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0d8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-139": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "5af42538-5e12-b5dd-a2cf-86297969a0e5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-141": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "cd39649f-ae66-ef57-0d4b-b512a12ec961",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-143": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "cd39649f-ae66-ef57-0d4b-b512a12ec969",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-145": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "cd39649f-ae66-ef57-0d4b-b512a12ec971",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-151": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c465bb1e3c6|ac5220f6-007d-69c5-1e1a-12eaf7fed661",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-153": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c465bb1e3c6|60cfa6aa-2bc4-b6db-edbd-4f344fa2877e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-155": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c465bb1e3c6|ac5220f6-007d-69c5-1e1a-12eaf7fed6d6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-157": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c6c60b1e3c5|f8919201-1bf8-e36c-d0e4-a2a57c2a9f15",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-158": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c6c60b1e3c5|6d47d01d-246e-bb3b-fd73-4df0fc415872",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-160": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c6c60b1e3c5|6d47d01d-246e-bb3b-fd73-4df0fc415880",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-162": {
      ...
      action: {
        ...
        actionTypeId: "GROW_EFFECT",
        instant: false,
        config: { actionListId: "growIn", autoStopEventId: "e-163" },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".projects-item",
        originalId:
          "6419710b82d66c6c60b1e3c5|f8dee495-6fad-4b91-c9ea-779809dd241b",
        appliesTo: "className",
      },
      targets: [
        {
    ...
    "e-164": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c6c60b1e3c5|cca45aa4-d8e9-04fd-47fd-1d32644b2d9f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-166": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c6c60b1e3c5|cca45aa4-d8e9-04fd-47fd-1d32644b2da9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-168": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c9ae5b1e3c8|55205c26-a0f1-ccf1-82ae-eabdb3ae473f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-170": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c9ae5b1e3c8|bf992a93-1ef3-f62d-68ee-ff5d07e9e687",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-172": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c9ae5b1e3c8|c5cf970e-c2f6-ab4f-cef1-d6ebcfabacfa",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-174": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c1b4db1e3d2|7f7c5d1f-8fd7-21dc-ec6e-28df20f8a1a0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-178": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7a87b1e3d5|9fd540ea-8d3e-fb06-99a6-a117372e6d35",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-180": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c5750b1e3d6|29826690-63ec-990d-359e-b2fedc68f824",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-182": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c5750b1e3d6|29826690-63ec-990d-359e-b2fedc68f7fa",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-184": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cde67b1e3d0|cd2a84f1-8be5-9b22-61d8-9da73cf857d2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-186": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|c830bc42-358b-b146-0184-b518e2315348",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-188": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c1721b1e3c3|1bf27d07-6c9b-5725-5fe2-e59b7df390d6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-190": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c1721b1e3c3|60d3fa3a5a19c1169cd58c4100000000000c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-192": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c108bb1e3d8|8cf27e6e-2f45-606b-9b14-9e4692c37bdc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-194": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c108bb1e3d8|3e1a9c70-4aed-df4f-0c57-660ae74897a0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-196": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c61efb1e3d4|bb9a89c7-13bd-79bc-2862-7a701aefb2ce",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-198": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c61efb1e3d4|75c8abd3-a30f-3c1b-2bcf-748c251443c4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-200": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cc6e3b1e3c9|c0c5b74d-9ba6-4bc8-011d-653fda8c42b9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-202": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cc6e3b1e3c9|c0c5b74d-9ba6-4bc8-011d-653fda8c42c5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-204": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cc6e3b1e3c9|c0c5b74d-9ba6-4bc8-011d-653fda8c42e0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-206": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cc6e3b1e3c9|60300ce5-b0b7-c146-fbc7-1495e12fd85f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-208": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c706cb1e3ca|de628385-1b53-fbe1-d79d-26ed65a22de2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-210": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c538ab1e3cc|074dddcf-ca0b-ea24-b6c8-c443a1146cff",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-212": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c538ab1e3cc|69c72317-1bdc-cf15-64b6-6d68a38f111c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-214": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|480e2a3d-964a-7af2-8c63-f5a5f627fb79",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-216": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|437efa35-f5df-ca2b-bcd3-009709de1505",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-218": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|103c0c79-3c82-b6dd-f7bf-dfa70928630f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-220": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|59478b25-5b84-545b-88a6-0112db343dfa",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-222": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|068c5cbe-a0cd-6204-bbfd-dbe72a0fe2a3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-224": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|6fa5e4bb-d53a-5e9b-f880-499ae0904774",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-226": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|883d03cc-a3cd-f945-93b3-41a8f79a845b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-228": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|fa14edb8-2bcf-1e01-52d7-974f7a1a7b22",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-230": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|fa14edb8-2bcf-1e01-52d7-974f7a1a7b2d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-232": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|fa14edb8-2bcf-1e01-52d7-974f7a1a7b37",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-234": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|fa14edb8-2bcf-1e01-52d7-974f7a1a7b41",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-236": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c8b25b1e3d3|050f42f6-9041-6c28-afe6-f09911946235",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-240": {
      ...
      target: {
        ...
        originalId: "5af42538-5e12-b5dd-a2cf-86297969a07d",
        appliesTo: "className",
      },
      targets: [
        {
    ...
    "e-242": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".button.is-icon.is-blog",
        originalId:
          "6419710b82d66c465bb1e3c6|7b30734a-210f-3f84-7fbf-d3f7da1a02c8",
        appliesTo: "className",
      },
      targets: [
        {
    ...
    "e-244": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c7a87b1e3d5|9fd540ea-8d3e-fb06-99a6-a117372e6d64",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-246": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c816cb1e3ce|efe2b5b7-48a9-edb3-53a4-6b1d20970002",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-248": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c816cb1e3ce|efe2b5b7-48a9-edb3-53a4-6b1d2097000c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-250": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66c1b4db1e3d2|7f7c5d1f-8fd7-21dc-ec6e-28df20f8a1a9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-252": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1b56be8d-c9e2-59ec-58e5-df231f37a70a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-254": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1b56be8d-c9e2-59ec-58e5-df231f37a721",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-256": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419710b82d66cc6e3b1e3c9|e7863792-6f53-518a-01ea-df8572f1536f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130ba8"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130baa"],
                },
                yValue: -8,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130ba7"],
                },
                yValue: 8,
                xUnit: "PX",
                yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130b92"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130b91"],
                },
                zValue: 180,
                xUnit: "DEG",
                yUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b1eebdc6-e537-cd3d-4e45-90b727130b90"],
                },
                globalSwatchId: "202587d0",
                rValue: 89,
                bValue: 255,
                gValue: 106,
                aValue: 1,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".faq-answer",
                  selectorGuids: ["44b18d67-cf0f-06de-7a72-96ffa3901e8a"],
                },
                widthValue: 100,
                heightValue: 0,
                widthUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".faq-icon",
                  selectorGuids: ["44b18d67-cf0f-06de-7a72-96ffa3901e89"],
                },
                zValue: 45,
                xUnit: "DEG",
                yUnit: "DEG",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b4a5a32e-d5d3-6860-1a30-f427e347584d"],
                },
                xValue: 0,
                xUnit: "px",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "6419710b82d66c7714b1e3bb|5599192b-db46-1764-43c3-8e0220708281",
                },
                xValue: 0.97,
                yValue: 0.97,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".button.is-integrations",
                  selectorGuids: [
                    "07815991-952a-8d98-0e00-e4c25af27158",
                    "2dc0abf8-d17f-a113-3a10-6706a0e9d53a",
                  ],
                },
                globalSwatchId: "",
                rValue: 248,
    ...
    "a-19": {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1674118247839,
    },
    "a-20": {
      id: "a-20",
      title: "👆 Slide Top [.2s Delay]",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-23": {
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1674121585063,
    },
    "a-25": {
      id: "a-25",
      title: "👆 Slide In [.6s Delay]",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-26": {
      id: "a-26",
      title: "Header Scrolling Animation",
      continuousParameterGroups: [
        {
          id: "a-26-p",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".illustration.is-features-top-left",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "a4a08305-8b39-2480-be58-a1a507c1b69e",
                      ],
                    },
                    yValue: 100,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".illustration.is-features-top-right",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "7b67878e-7507-7424-83d4-e2ac07796ce7",
                      ],
                    },
                    yValue: -50,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".illustration.is-features",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "9d7bef49-7e2d-fe96-2ac7-91e1b29aa173",
                      ],
                    },
                    yValue: -50,
                    xUnit: "PX",
      ...
      createdOn: 1674126895171,
    },
    "a-27": {
      id: "a-27",
      title: "About Header Scrolling Animation",
      continuousParameterGroups: [
        {
          id: "a-27-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "SIBLINGS",
                      selector: ".illustration.is-about-top-right",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "4ce4a38b-2c46-5fa6-b66b-c85dd2cba121",
                      ],
                    },
                    yValue: -50,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "SIBLINGS",
                      selector: ".illustration.is-about-bottom-left",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "baa11756-0c76-279f-0d9b-582ec9f064c4",
                      ],
                    },
                    yValue: 50,
                    xUnit: "PX",
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "SIBLINGS",
                      selector: ".illustration.is-about-bottom-right",
                      selectorGuids: [
                        "ba15feb6-ef50-30d1-8ae3-bea416e38b43",
                        "b1adaa93-f419-4e14-1049-bfa788736718",
                      ],
                    },
                    yValue: -50,
                    xUnit: "PX",
    ...
    "a-15": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".features-card",
                  selectorGuids: ["49dc2420-b941-e7b2-d9eb-6b370b8da348"],
                },
                globalSwatchId: "9853ee08",
                rValue: 255,
                bValue: 255,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".button.features",
                  selectorGuids: [
                    "07815991-952a-8d98-0e00-e4c25af27158",
                    "9267e54f-86b5-8ed8-6078-9b30f2c322fc",
                  ],
                },
                globalSwatchId: "8801225f",
                rValue: 67,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["4550e315-cd21-23a0-fe93-a52a2b1d66fa"],
                },
                globalSwatchId: "7d5dbab1",
                rValue: 20,
                bValue: 48,
                gValue: 28,
                aValue: 1,
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1674107401253,
    },
    "a-16": {
      id: "a-16",
      title: "Features Card [Hover Out]",
      actionItemGroups: [
        {
          actionItems: [
            {
